...
export interface ApiGbvIssueGbvIssue extends Struct.CollectionTypeSchema {
  collectionName: 'gbv_issues';
  info: {
    displayName: 'GBV Issue';
    pluralName: 'gbv-issues';
    singularName: 'gbv-issue';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiTooltypeTooltype extends Struct.CollectionTypeSchema {
  collectionName: 'tooltypes';
  info: {
    displayName: 'Tooltype';
    pluralName: 'tooltypes';
    singularName: 'tooltype';
  };
  options: {
    draftAndPublish: false;
  };
